...
env = environ.FileAwareEnv(
    ...
    DD_SOCIAL_AUTH_KEYCLOAK_USERINFO_URL=(str, ''),
    DD_SOCIAL_AUTH_KEYCLOAK_LOGIN_BUTTON_TEXT=(str, 'Login with Keycloak'),
    DD_SOCIAL_AUTH_KEYCLOAK_GET_GROUPS=(bool, False),
    DD_SOCIAL_AUTH_KEYCLOAK_GROUPS_FILTER=(str, ''),
...
KEYCLOAK_OAUTH2_GET_GROUPS = env('DD_SOCIAL_AUTH_KEYCLOAK_GET_GROUPS')
KEYCLOAK_OAUTH2_GROUPS_FILTER = env('DD_SOCIAL_AUTH_KEYCLOAK_GROUPS_FILTER')
...
SOCIAL_AUTH_KEYCLOAK_USERINFO_URL = env('DD_SOCIAL_AUTH_KEYCLOAK_USERINFO_URL')
